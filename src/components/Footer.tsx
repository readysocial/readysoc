...
export default function Footer() {
  ...
  return (
    <footer className="bg-white py-8 sm:py-10 md:py-12 px-4 sm:px-6 lg:px-8">
      <div className="container mx-auto max-w-7xl">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8">
          {/* About Us */}
          <div className="md:col-span-1">
            <h3 className="text-xl sm:text-2xl font-bold text-gray-900 mb-3 sm:mb-4">Ready Social</h3>
            ...
            <div className="flex space-x-3 sm:space-x-4">
              <a href="https://www.facebook.com/share/1W5wNcWBAu/" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="w-8 h-8 sm:w-9 sm:h-9">
              ...
              <a href="https://www.instagram.com/ready_social?igsh=YzljYTk1ODg3Zg==" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="w-8 h-8 sm:w-9 sm:h-9">
                <svg width="100%" height="100%" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <a href="https://x.com/readyy_social?t=a4UdyA1lPJRtojDSLnyxyQ&s=08" target="_blank" rel="noopener noreferrer" aria-label="X (Twitter)" className="w-8 h-8 sm:w-9 sm:h-9">
                <svg width="100%" height="100%" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          {/* Customer Service */}
          <div>
            <h4 className="text-base sm:text-lg font-bold text-gray-900 mb-3 sm:mb-4">Customer Service</h4>
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-base sm:text-lg font-bold text-gray-900 mb-3 sm:mb-4">Quick Links</h4>
            <ul className="space-y-2 sm:space-y-3 text-xs sm:text-sm text-gray-600">
              <li>
                <button 
          ...
          {/* Contact Info */}
          <div>
            <h4 className="text-base sm:text-lg font-bold text-gray-900 mb-3 sm:mb-4">Contact Info</h4>
            <ul className="space-y-2 sm:space-y-3 text-xs sm:text-sm text-gray-600">
        ...
        <div className="border-t-2 border-gray-900 mt-8 sm:mt-10 md:mt-12 pt-6 sm:pt-8 text-left pl-4">
          <p className="text-xs sm:text-sm font-semibold text-gray-900">Copyright © 2025 <span className="text-[#5CC3EB]">Ready Socials</span>. All Rights Reserved.</p>
        </div>
      </div>
    </footer>
  );
