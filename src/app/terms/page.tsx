  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      <div className="container mx-auto max-w-3xl px-4 py-12 flex-1">
        ...
        <h2 className="text-2xl font-bold text-black mb-2 mt-8">Eligibility</h2>
        <ul className="list-disc pl-6 mb-6 text-gray-800">
        ...
        <h2 className="text-2xl font-bold text-black mb-2 mt-8">Account Registration</h2>
        <ul className="list-disc pl-6 mb-6 text-gray-800">
        ...
        <h2 className="text-2xl font-bold text-black mb-2 mt-8">Community Guidelines</h2>
        <ul className="list-disc pl-6 mb-6 text-gray-800">
        ...
        <h2 className="text-2xl font-bold text-black mb-2 mt-8">Listener Sessions</h2>
        <ul className="list-disc pl-6 mb-6 text-gray-800">
        ...
        <h2 className="text-2xl font-bold text-black mb-2 mt-8">Privacy and Data Use</h2>
        <ul className="list-disc pl-6 mb-6 text-gray-800">
        ...
        <h2 className="text-2xl font-bold text-black mb-2 mt-8">User Responsibilities</h2>
        <ul className="list-disc pl-6 mb-6 text-gray-800">
        ...
        <h2 className="text-2xl font-bold text-black mb-2 mt-8">Termination</h2>
        <ul className="list-disc pl-6 mb-6 text-gray-800">
        ...
        <h2 className="text-2xl font-bold text-black mb-2 mt-8">Governing Law</h2>
        <ul className="list-disc pl-6 mb-6 text-gray-800">
          <li>These Terms are governed by and construed in accordance with the laws of the Federal Republic of Nigeria.</li>
        </ul>

        <h2 className="text-2xl font-bold text-black mb-2 mt-8">Modifications to the Terms</h2>
        <ul className="list-disc pl-6 mb-6 text-gray-800">
        ...
        <h2 className="text-2xl font-bold text-black mb-2 mt-8">Contact Us</h2>
        <ul className="list-disc pl-6 mb-6 text-gray-800">
