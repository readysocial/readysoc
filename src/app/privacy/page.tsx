  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      <div className="container mx-auto max-w-3xl px-4 py-8 md:py-12 flex-1">
        <h1 className="text-3xl md:text-4xl lg:text-5xl font-extrabold text-center mb-8 md:mb-10 text-black">Privacy Policy</h1>
        <p className="mb-6 md:mb-8 text-sm md:text-base lg:text-lg text-gray-800">We are committed to protecting your privacy and ensuring that your personal data is handled responsibly. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our platform. By accessing or using Ready Social, you agree to the practices described in this policy. If you do not agree, please do not use our platform.</p>

        <h2 className="text-lg md:text-xl lg:text-2xl font-bold text-black mb-2 mt-6 md:mt-8">1. Who We Are</h2>
        <p className="mb-4 md:mb-6 text-sm md:text-base text-gray-800">Ready Social is a platform designed to help users create meaningful connections across three core areas: Life, Love, and Work. Our mission is to foster genuine human connections while prioritizing your privacy and data security.</p>

        <h2 className="text-lg md:text-xl lg:text-2xl font-bold text-black mb-2 mt-6 md:mt-8">2. Information We Collect</h2>
        <p className="mb-2 text-sm md:text-base text-gray-800">We collect various types of information to enhance your experience on Ready Social. This includes:</p>
        <ul className="list-disc pl-4 md:pl-6 mb-4 text-sm md:text-base text-gray-800">
        ...
        <h2 className="text-lg md:text-xl lg:text-2xl font-bold text-black mb-2 mt-6 md:mt-8">How We Use Your Information</h2>
        ...
        <h2 className="text-lg md:text-xl lg:text-2xl font-bold text-black mb-2 mt-6 md:mt-8">4. How We Share Your Information</h2>
        <p className="mb-2 text-sm md:text-base text-gray-800">We may share your information in the following circumstances:</p>
        <ul className="list-disc pl-4 md:pl-6 mb-4 md:mb-6 text-sm md:text-base text-gray-800">
        ...
        <h2 className="text-lg md:text-xl lg:text-2xl font-bold text-black mb-2 mt-6 md:mt-8">Your Privacy Choices</h2>
        <p className="mb-2 text-sm md:text-base text-gray-800">You have control over your personal information. Depending on your jurisdiction, you may have the following rights:</p>
        <ul className="list-disc pl-4 md:pl-6 mb-4 md:mb-6 text-sm md:text-base text-gray-800">
        ...
        <h2 className="text-lg md:text-xl lg:text-2xl font-bold text-black mb-2 mt-6 md:mt-8">Data Security</h2>
        <p className="mb-4 md:mb-6 text-sm md:text-base text-gray-800">We implement robust technical, administrative, and organizational measures to protect your data against unauthorized access, loss, or misuse. However, no system is entirely secure, and we cannot guarantee the absolute security of your information.</p>

        <h2 className="text-lg md:text-xl lg:text-2xl font-bold text-black mb-2 mt-6 md:mt-8">Data Retention</h2>
        <p className="mb-4 md:mb-6 text-sm md:text-base text-gray-800">We retain your personal data for as long as necessary to fulfill the purposes outlined in this policy, comply with legal obligations, or resolve disputes. If you deactivate your account, we will delete your data unless retention is required by law.</p>

        <h2 className="text-lg md:text-xl lg:text-2xl font-bold text-black mb-2 mt-6 md:mt-8">Cookies and Tracking Technologies</h2>
        <ul className="list-disc pl-4 md:pl-6 mb-4 md:mb-6 text-sm md:text-base text-gray-800">
        ...
        <h2 className="text-lg md:text-xl lg:text-2xl font-bold text-black mb-2 mt-6 md:mt-8">Children&apos;s Privacy</h2>
        <p className="mb-4 md:mb-6 text-sm md:text-base text-gray-800">Ready Social is not intended for users under the age of 18. We do not knowingly collect personal data from minors. If we become aware of such data collection, we will delete it promptly.</p>

        <h2 className="text-lg md:text-xl lg:text-2xl font-bold text-black mb-2 mt-6 md:mt-8">Modifications to This Privacy Policy</h2>
        <p className="mb-4 md:mb-6 text-sm md:text-base text-gray-800">We may update this Privacy Policy periodically to reflect changes in our practices or for legal reasons. We encourage you to review it regularly. Significant changes will be communicated to you via email or in-app notifications.</p>
      </div>
      <Footer />
    </div>
  );
